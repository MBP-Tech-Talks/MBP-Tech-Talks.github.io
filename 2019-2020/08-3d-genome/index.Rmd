...
![](figures/dna-shape.png){width=250px}
...
![RNA PolII binds to promoter regions]()

* Promoter-enhancer loops brings these loci together
...
## Measuring chromatin organization(3C)
...
## Measure chromatin organization across with genome with HiC
...
## Intra-sample normalization | Iterative correction

<div class="columns-2">
![](figures/iterative-correction.png){width=300px}
